    ...
    return (
      <div className="relative overflow-hidden bg-[#0a0118]">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute -top-32 -left-24 h-96 w-96 rounded-full bg-purple-500/20 blur-[120px]" />
          <div className="absolute top-1/3 -right-24 h-[28rem] w-[28rem] rounded-full bg-violet-600/20 blur-[130px]" />
          <div className="absolute bottom-0 left-1/3 h-96 w-96 rounded-full bg-purple-500/10 blur-[120px]" />
        ...
        <div className="container relative px-4 py-12 mx-auto sm:px-6 sm:py-16">
          ...
          <div className="flex flex-col items-center max-w-2xl mx-auto text-center mb-14 sm:mb-20">
            <div className="relative mb-5">
              ...
              <img
                ...
                alt="logo"
                className="relative w-16 h-16 shadow-lg rounded-2xl shadow-purple-500/20 ring-1 ring-white/10 sm:h-20 sm:w-20"
              />
            </div>
            <p className="mb-2 text-xs font-semibold uppercase tracking-[0.3em] text-purple-400/80 sm:text-sm">
              BGG4 Assistant
            </p>
            <h1 className="text-3xl font-bold text-white sm:text-4xl">
              테이블 위의 모든 게임,{" "}
              <span className="text-transparent bg-gradient-to-r from-purple-300 to-violet-300 bg-clip-text">
                한 곳에서
              </span>
            </h1>
          ...
          <div className="flex items-end justify-between max-w-5xl px-1 mx-auto mb-5">
            <div>
              <p className="text-xs font-semibold tracking-widest uppercase text-purple-400/70">
                Library
              </p>
          ...
          <div className="grid max-w-5xl grid-cols-2 gap-4 mx-auto sm:grid-cols-3 sm:gap-6 md:grid-cols-4 lg:grid-cols-5">
            {homeScreenItems.map((item) => (
              <button
                ...
                className="group relative aspect-[3/4] overflow-hidden rounded-2xl border border-white/10 bg-[#170a2e]/60 shadow-lg transition-all duration-300 ease-out hover:-translate-y-1.5 hover:border-purple-400/40 hover:shadow-2xl hover:shadow-purple-500/20 focus:outline-none focus-visible:ring-2 focus-visible:ring-purple-400"
              >
                {!item.isCustomIcon && (
                  <div className="absolute inset-0 bg-gradient-to-br from-[#2a1350] to-[#0a0118]" />
                )}

                <IconRenderer item={item} />

                {item.tag && (
                  <span className="absolute left-2 top-2 z-10 rounded-full bg-black/50 px-2 py-0.5 text-[9px] font-medium text-purple-200 ring-1 ring-white/10 sm:text-[10px]">
                    {item.tag}
                  </span>
                )}
                ...
                <ArrowUpRightIcon className="absolute z-10 w-6 h-6 p-1 transition-all duration-300 -translate-y-1 rounded-full shadow-md opacity-0 right-2 top-2 bg-purple-400/90 text-[#0a0118] group-hover:translate-y-0 group-hover:opacity-100" />
                ...
                <div className="absolute inset-0 transition-all duration-300 rounded-2xl ring-1 ring-inset ring-white/5 group-hover:ring-purple-300/30" />
              </button>
            ))}
