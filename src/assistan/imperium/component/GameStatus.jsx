            ...
            <div className="relative bg-[#0a0118]">
                ...
                <div className="relative container mx-auto max-w-3xl px-4 py-8 sm:px-6 sm:py-12">
                    ...
                    <div className="mb-8 flex items-center gap-3">
                        ...
                        <div>
                            <p className="text-xs font-semibold uppercase tracking-widest text-purple-400/70">게임 진행 중</p>
                    ...
                    <Button
                        ...
                        className={`mt-2 w-full gap-2 py-3.5 text-base shadow-lg ${
                            this.state.canCalculateScore
                                ? 'bg-gradient-to-r from-emerald-400 to-purple-400 text-[#0a0118] shadow-emerald-500/20 hover:brightness-110'
