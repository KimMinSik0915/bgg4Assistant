            ...
            <div className="relative bg-[#0a0118]">
                ...
                <div className="relative container mx-auto max-w-3xl px-4 py-8 sm:px-6 sm:py-12">
                    ...
                    <div className="mb-8 flex items-center gap-3">
                        ...
                        <div>
                            <p className="text-xs font-semibold uppercase tracking-widest text-purple-400/70">임페리움: 레전드</p>
                    ...
                    <div className="mb-5 flex items-center justify-between rounded-2xl border border-white/10 bg-white/5 px-4 py-3">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <Button onClick={this.handler.player.addPlayer} disabled={this.state.players.length >= 4} className="bg-purple-400/15 text-purple-300 hover:bg-purple-400/25">
                                <PlusCircle size={18} />
                            </Button>
                        </div>
                    </div>
                    ...
                    <Button
                        ...
                        className={`w-full py-3.5 text-base shadow-lg ${
                            readyToStart
                                ? 'bg-gradient-to-r from-purple-400 to-violet-400 text-[#0a0118] shadow-purple-500/20 hover:brightness-110'
