...
import {
    GEMINI_KEY_STORAGE, GEMINI_MODEL_STORAGE, DEFAULT_GEMINI_MODEL
  , GM_RESPONSE_SCHEMA, LOCATION_LOOKUP_SCHEMA, GM_STATIC_RULES
} from "../resource/dataSet/gmConfig";
...
// 🧷 GM 응답 강제 스키마(GM_RESPONSE_SCHEMA)와 지도 비전 조회 스키마(LOCATION_LOOKUP_SCHEMA)는
// multiplayerService.js(2인 협동 세션)도 동일하게 써야 해서 resource/dataSet/gmConfig.js로 옮겼다.
...
class CharacterSheetManager extends Component {
    ...
    buildGmSystemInstruction = () => {
        ...
        const instructionParts = [GM_STATIC_RULES];
